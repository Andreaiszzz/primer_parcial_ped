...
void generarInforme(PuntoTrayectoria puntos[], int cantidad) {
    ...
    cout << "INFORME DE TRAYECTORIA" << endl;
    ...
    cout << "Puntos CERCANOS: " << cercanos << endl;
    cout << "Puntos INTERMEDIOS: " << intermedios << endl;
    cout << "Puntos LEJANOS: " << lejanos << endl;
    cout << "Puntos EXTREMOS: " << extremos << endl;

    if (cantidad > 0) {
        float promedio = suma_distancias / cantidad;
        cout << "Distancia promedio: " << floatATexto(promedio) << endl;
    }
}
...
void mostrarEncabezado() {
    cout << rellenarDerecha("ID", 6)
         << rellenarDerecha("NOMBRE", 20)
         << rellenarIzquierda("X", 10)
         << rellenarIzquierda("Y", 10)
         << rellenarIzquierda("Z", 10)
         << rellenarIzquierda("DISTANCIA", 12)
         << "   " << "CLASIFICACION" << endl;
}
...
int main() {
    ...
    cout << "ANALISIS DE TRAYECTORIA - ROBOT AUTONOMO" << endl;

    do {
        cout << "1. Registrar puntos de trayectoria" << endl;
        cout << "2. Calcular distancias y clasificar" << endl;
        cout << "3. Mostrar el punto mas alejado" << endl;
        cout << "4. Corregir coordenadas de un punto" << endl;
        cout << "5. Generar informe de trayectoria" << endl;
        cout << "6. Salir" << endl;
        ...
        if (opcion == 1) {
            cantidad = leerEntero(
                "Cantidad de puntos a registrar (1-10): ",
                1,
                kMaxPuntos
            );
            ...
            if (!registrados) {
                cout << "Primero debe registrar los puntos." << endl;
            } else {
                procesarTodos(puntos, cantidad);

                cout << "DISTANCIAS Y CLASIFICACIONES" << endl;
            ...
            if (!registrados) {
                ...
                PuntoTrayectoria *mas_alejado =
                    obtenerPuntoMasAlejado(puntos, cantidad);

                if (mas_alejado != NULL) {
                    cout << "PUNTO MAS ALEJADO DEL ORIGEN" << endl;
                    cout << "ID: " << mas_alejado->id << endl;
                    cout << "Nombre: " << mas_alejado->nombre << endl;
                    cout << "Coordenada X: "
                         << floatATexto(mas_alejado->coordenadas[0]) << endl;
                    cout << "Coordenada Y: "
                         << floatATexto(mas_alejado->coordenadas[1]) << endl;
                    cout << "Coordenada Z: "
                         << floatATexto(mas_alejado->coordenadas[2]) << endl;
                    cout << "Distancia: "
                         << floatATexto(mas_alejado->distanciaOrigen) << endl;
                    cout << "Clasificacion: "
                         << mas_alejado->clasificacion << endl;
                }
            }
            ...
            if (!registrados) {
                ...
                cout << "CORRECCION DE COORDENADAS" << endl;

                for (int i = 0; i < cantidad; i++) {
                    cout << (i + 1)
                         << ") ID " << puntos[i].id
                         << " - " << puntos[i].nombre << endl;
                }

                int seleccion = leerEntero(
                    "Seleccione el punto a corregir: ",
                    1,
                    cantidad
                );
